package gas.annotations.entities;
...
public class ModEntityIO {
    ...
    void write(MethodSpec.Builder method, boolean write) throws Exception{
        ...
        method.addAnnotation(GasAnnotations.CallSuper.class);
    ...
    void writeSync(MethodSpec.Builder method, boolean write, Seq<Svar> syncFields, Seq<Svar> allFields) throws Exception{
        ...
        if(write){
            ...
            for(RevisionField field : rev.fields){
                ...
                boolean sf = var.has(GasAnnotations.SyncField.class), sl = var.has(GasAnnotations.SyncLocal.class);
    ...
    void writeInterpolate(MethodSpec.Builder method, Seq<Svar> fields) throws Exception{
        ...
        for(Svar field : fields){
            ...
            st("$L = $L($T.$L($L, $L, alpha))", name, field.annotation(GasAnnotations.SyncField.class).clamped() ? "arc.math.Mathf.clamp" : "", Mathf.class, field.annotation(GasAnnotations.SyncField.class).value() ? "lerp" : "slerp", lastName, targetName);
        }
