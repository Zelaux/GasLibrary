 ...
 */
@Deprecated
public class GasAttributeSmelter extends GasAttributeCrafter {
    ...
    public GasAttributeSmelter(String name) {
        super(name);
    }

    // unused, kept for compatibility
    @Deprecated
    public class GasAttributeSmelterBuild extends GasAttributeCrafterBuild {
    }
}
