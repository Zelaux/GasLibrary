...
public class GasForceProjector extends GasBlock {
    ...
    static GasForceBuild paramEntity;
    ...
    public void setBars() {
        super.setBars();
        bars.add("shield", (GasForceBuild entity) -> new Bar("stat.shieldhealth", Pal.accent, () -> entity.broken ? 0f : 1f - entity.buildup / (shieldHealth + phaseShieldBoost * entity.phaseHeat)).blink(Color.white));
    }
